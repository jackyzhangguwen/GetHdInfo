...
namespace DuiLib
{
	...
	{
		if (m_diDisabled.sDrawString == pStrImage &&
			m_diDisabled.pImageInfo != NULL) {
			return;
		}
		m_diDisabled.Clear();
	...
	{
		if (m_diFore.sDrawString == pStrImage &&
			m_diFore.pImageInfo != NULL) {
			return;
		}
		m_diFore.Clear();
	...
	{
		if (m_diHotFore.sDrawString == pStrImage &&
			m_diHotFore.pImageInfo != NULL) {
			return;
		}
		m_diHotFore.Clear();

...
{
	if (m_diSelected.sDrawString == pStrImage &&
		m_diSelected.pImageInfo != NULL) {
		return;
	}
	m_diSelected.Clear();
...
{
	if (m_diSelectedHot.sDrawString == pStrImage &&
		m_diSelectedHot.pImageInfo != NULL) {
		return;
	}

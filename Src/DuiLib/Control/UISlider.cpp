...
{
	if (m_diThumb.sDrawString == pStrImage &&
		m_diThumb.pImageInfo != NULL) {
		return;
	}
	m_diThumb.Clear();
...
{
	if (m_diThumbHot.sDrawString == pStrImage &&
		m_diThumbHot.pImageInfo != NULL) {
		return;
	}
	m_diThumbHot.Clear();
...
{
	if (m_diThumbPushed.sDrawString == pStrImage &&
		m_diThumbPushed.pImageInfo != NULL) {
		return;
	}
